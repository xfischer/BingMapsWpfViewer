    ...
    public class Messenger : IMessenger
    {
        ...
        void Register(string message, Delegate callback, Type parameterType)
        {
            if (String.IsNullOrEmpty(message))
                throw new ArgumentException("'message' ne peut pas être null ou vide.");
        ...
        {
            if (String.IsNullOrEmpty(message))
                throw new ArgumentException("'message' ne doit pas être null ou vide.");
            ...
            if (_messageToActionsMap.TryGetParameterType(message, out registeredParameterType))
            {
                if (registeredParameterType == null)
                    throw new TargetParameterCountException(string.Format("Le message '{0}' ne prend pas de paramètre.", message));
            }
        ...
        public void NotifyColleagues(string message)
        {
            ...
            {
                if (registeredParameterType != null)
                    throw new TargetParameterCountException(string.Format("Il faut fournir un paramètre pour le message '{0}'.", registeredParameterType.FullName));
            }
